...
sidebar_label: Find a Corresponding Node of a Binary Tree in a Clone of That Tree
---
## Description
...
var getTargetCopy = function(original, cloned, target) {
    ...
    function traverse(originalNode, clonedNode) {
        ...
        return traverse(originalNode.left, clonedNode.left) || traverse(originalNode.right, clonedNode.right);
    }
